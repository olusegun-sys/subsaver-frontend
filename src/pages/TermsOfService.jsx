        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
              ...
              <li>Annual: ₦25,000/year (save ₦17,000 vs monthly)</li>
              <li>Payments are processed securely via Paystack</li>
              <li>Payments are non-refundable once premium access is granted</li>
              <li>You can cancel your Premium subscription at any time</li>
              <li>Premium access expires at the end of your paid period</li>
            </ul>
          </section>

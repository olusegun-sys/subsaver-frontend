        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-700 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-semibold">Trusted by 50+ Nigerians</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button onClick={() => scrollToSection('how-it-works')} className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-xl text-lg font-semibold hover:border-blue-600 hover:text-blue-600 transition-all duration-300">
                Watch demo
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 bg-green-100 text-green-700 px-4 py-2 rounded-full mb-4">
              ...
              <span className="font-semibold">Join 50+ members saving money</span>
            </div>
            <p className="text-2xl text-gray-700 max-w-3xl mx-auto">
              "Subsaver helped me find over ?75,000 in forgotten subscriptions in just 5 minutes!"
            </p>
            <p className="text-gray-500 mt-4">— Ada L., Lagos</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              <div className="w-14 h-14 bg-blue-100 rounded-xl flex items-center justify-center mb-5 group-hover:bg-blue-600 transition-colors duration-300">
                <Wallet className="w-7 h-7 text-blue-600 group-hover:text-white transition-colors duration-300" />
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              <div className="w-14 h-14 bg-blue-100 rounded-xl flex items-center justify-center mb-5 group-hover:bg-blue-600 transition-colors duration-300">
                <Eye className="w-7 h-7 text-blue-600 group-hover:text-white transition-colors duration-300" />
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-12">
            <div className="text-center p-4">
              ...
              <p className="font-semibold">Track spending</p>
            </div>
            <div className="text-center p-4">
      ...
      <section id="testimonials" className="bg-gray-50 py-24 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300">
              <div className="flex gap-1 text-yellow-500 mb-4">?????</div>
              <p className="text-gray-700 mb-4">"The SMS reminder saved me from a ?15,000 annual renewal I completely forgot about."</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
            ...
            <div className="col-span-2">
              ...
              <p className="text-sm mb-4">Helping Nigerians save money from forgotten subscriptions.</p>
